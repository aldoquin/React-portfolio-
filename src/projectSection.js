...
export default function projectSection() {
  ...
  <Card.Body>
    ...
    <Button href="https://peaceful-hollows-57596.herokuapp.com/" style={{marginLeft:'auto',marginRight:'auto',display:'block'}} variant="primary">launch</Button>
  </Card.Body>
</Card></Col>
<Col><Card style={{ width: '18rem',marginLeft:'auto',marginRight:'auto',display:'block' }}>
  ...
  <Card.Body>
    ...
    <Button href="https://agile-everglades-77525.herokuapp.com/" style={{marginLeft:'auto',marginRight:'auto',display:'block'}} variant="primary">launch</Button>
  </Card.Body>
</Card></Col>
<Col><Card style={{width: '18rem',marginLeft:'auto',marginRight:'auto',display:'block'  }}>
  ...
  <Card.Body>
    ...
    <Button href="https://aldoquin.github.io/Password-Generator/" style={{marginLeft:'auto',marginRight:'auto',display:'block'}} variant="primary">launch</Button>
  </Card.Body>
</Card></Col>
      </Row>
      <Row style ={{padding:"2%",background:'radial-gradient(circle, rgba(2,0,36,1) 0%, rgba(138,201,233,1) 100%, rgba(0,212,255,1) 100%)'}}>
  ...
  <Card.Body>
    ...
    <Button href="https://aldoquin.github.io/Weather_app/" style={{marginLeft:'auto',marginRight:'auto',display:'block'}} variant="primary">launch</Button>
  </Card.Body>
</Card></Col>
<Col><Card style={{width: '18rem',marginLeft:'auto',marginRight:'auto',display:'block'  }}>
  ...
  <Card.Body>
    ...
    <Button href='https://aldoquin.github.io/Quiz-game/' style={{marginLeft:'auto',marginRight:'auto',display:'block'}} variant="primary">launch</Button>
  </Card.Body>
</Card></Col>
<Col ><Card style={{width: '18rem',marginLeft:'auto',marginRight:'auto',display:'block'  }}>
  ...
  <Card.Body>
    ...
    <Button href="https://evening-bayou-30737.herokuapp.com/" style={{marginLeft:'auto',marginRight:'auto',display:'block'}} variant="primary">launch</Button>
  </Card.Body>
</Card></Col>
      </Row> 
    </div>
